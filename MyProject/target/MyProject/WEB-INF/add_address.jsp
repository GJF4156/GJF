...
<form action="${pageContext.request.contextPath}/address/insertAddress">
    ...
    <div class="demo" style="background: white;margin-top: 2px">
        <input type="submit" value="提交" style="width:100px;height:25px;margin-right:60px;background:#79bbff;color: #000000;float: right"/>
    </div>
</form>
</body>
</html>
