        ...
        <c:forEach items="${ADDRESSLIST}" var="a">
            <li class="curr">
                ...
                <div class="address-cz">
                    <a style="float: left"
                       href="${pageContext.request.contextPath}/update_address?aid=${a.aid}&consignee=${a.consignee}&cphone=${a.cphone}&content=${a.content}&testId=1">
                        <img src="${pageContext.request.contextPath}/images/bj.png" style="width: 18px;">&nbsp;编辑</a>
