    ...
    <a href="content.jsp">
        ...
        <div class="am-intro-right am-u-sm-9">
            <div class="text">
                ...
                <span class="fr" style="margin-right: 2%"><i><i class="am-icon-phone"></i></i></span>
            </div>
...
<div class="communityPage-publish-btn cmn-theme-bgcolor" id="communityPage-publish-btn"><a id="go_order"
                                                                                           href="run_order.jsp"
                                                                                           style="color: white">举报</a>
</div>
