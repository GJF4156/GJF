...
////        Typeface font = Typeface.createFromAsset(getAssets(), "iconfy/iconfont.ttf");
...
public class MainActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener,
    ...
    private void bindViews() {
        ...
        rb_message = (RadioButton) findViewById(R.id.rb_sort);
        rb_better = (RadioButton) findViewById(R.id.rb_shop);
        rb_setting = (RadioButton) findViewById(R.id.rb_my);
