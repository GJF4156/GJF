...
public class TabBarAdapter extends RecyclerView.Adapter<TabBarAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view){
            super(view);
            iconTextView=view;
            icon=view.findViewById(R.id.tab_bar_icon);
            iconText=view.findViewById(R.id.tab_bar_icon_text);
        }
    }

    public TabBarAdapter(List<IconText> iconTextList,addClickListerner listener){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,int viewType){
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.tab_bar_icon,parent,false);
        ...
        holder.iconTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // Toast.makeText(v.getContext(),"点击"+iconText.getIcontext(),Toast.LENGTH_SHORT).show();
