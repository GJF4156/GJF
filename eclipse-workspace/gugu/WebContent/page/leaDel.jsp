...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-right">
      ...
      <li class="layui-nav-item"><a href="index.jsp">回到主页</a></li>
    </ul>
  </div>
    		...
    		<tbody>
 			...
 			%>
 				...
 				<tr>
        			...
        			<td><%=com.getComContent()%></td>
        			<td><%=com.getComDate()%></td>
        			<td><button class="layui-btn"  onclick="javascrtpt:window.location.href='LeaDelServlet?comId=<%=com.getComId()%>'"  >删除</button></td>
      			</tr>
     		<%
     			p--;
     		}
